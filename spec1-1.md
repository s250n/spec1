...
> В данный момент магазин работает в связке wordpress/woocommerce + crm мойсклад (приложение должно работать в связке с онлайн-магазином и crm мойсклад), в настоящее время примерное количество товаров 1000шт, в дальнейшем планируется увеличение количества.
